...
node test/e2e/movefx.cjs       # 招式演出：61 招都放得完、打中會頓一下震一下、粒子不爆量、減少震動的設定有效
...
**演出（參考原作 X・Y 的對戰動畫，`src/renderer/scene/movefx.js`）**
- 蓄力：光從四周吸進嘴巴，慢慢變亮
- 光束是一整條會脈動的光（外層屬性色、中心白色，外面繞著亮點）；電擊是每一瞬間都在變的閃電
- 發射物會發光、拖著尾巴；衝撞會留下殘影和速度線；暗襲要害是交叉的刀光；飛身重壓落地有衝擊波
- 打中時：打擊火花、衝擊波、光，加上各屬性的碎片（火舌往上竄、水花、小閃電、葉子、冰晶、石塊、黑影、龍的漩渦…），
  而且整個畫面「頓一下」再震一下
- 效果絕佳更誇張：放射狀的光、第二道衝擊波、震比較久
- 設定裡的「減少閃光和畫面震動」：不震動、光比較淡
